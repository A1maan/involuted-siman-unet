...
pretrained_weights_path = os.path.join(project_root, "weights/best_involuted_siman_unet_isic2017.pth")
...
plt.savefig(os.path.join(plots_dir, 'involuted_siman_unet_predictions_with_metrics_isic2017.png'), dpi=300, bbox_inches='tight')
plt.show()
