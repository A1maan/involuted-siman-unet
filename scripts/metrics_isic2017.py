...
parser = argparse.ArgumentParser(description="Evaluate on ISIC2017")
...
pretrained_weights_path = os.path.join(project_root, f"weights/best_{args.model}_unet_isic2017.pth")
...
test_metrics = evaluate_model_metrics(model, test_loader_2017, device)

# Display results
print("ISIC2017 Test Dataset Results:")
print("=" * 50)
...
plt.savefig(os.path.join(plots_dir, f'{args.model}_unet_predictions_with_metrics_isic2017.png'), dpi=300, bbox_inches='tight')
plt.show()
